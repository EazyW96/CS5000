...
public class ComputeTax {
    ...
    public static void main(String[] args) {
        ...
        // prompt the user to enter taxable incom
        ...
        if (status == 0) {
            ...
            if (income <= 16700) {
                ...
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15
                        + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28
                        + (372950 - 208850) * 0.33 + (income - 372950) * 0.38;
            }
        ...
        } else if (status == 3) { // Compute tax for head of house hold  
            // Left as an exercise in Programming Exercise 3.13
            if (income <= 11950)
                tax = income * 0.10;
                ...
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
                        (117450 - 45500) * 0.25 + (income - 11950) * 0.28;
            else if (income <= 372950)
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 +
